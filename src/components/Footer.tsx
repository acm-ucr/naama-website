    ...
    <div className="bg-naama-blue-200 text-naama-ivory-100 font-nunito w-full items-center justify-center p-10">
      <div className="grid grid-cols-5 gap-4">
        ...
        <div className="flex justify-center gap-4">
          ...
          <div className="flex flex-col gap-2">
          <a href="https://naamanextgen.com/" target="_blank" rel="noopener noreferrer">Membership Form</a>
        ...
        <div className="flex justify-center gap-4">
          ...
          <div className="flex flex-col gap-2">
          <a href="https://www.instagram.com/naamaucr" target="_blank" rel="noopener noreferrer">Instagram</a>
          <a href="https://linktr.ee/naamaucr" target="_blank" rel="noopener noreferrer">Linktree</a>
          </div>
        </div>
      </div>
