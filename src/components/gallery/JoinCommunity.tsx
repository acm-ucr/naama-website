...
const JoinCommunity = () => {
  return (
    <div className="bg-naama-blue-100 relative flex h-[50vh] w-full justify-center overflow-hidden text-white md:h-[40vw]">
      <div className="to-naama-blue-100 absolute aspect-square h-full w-3/4 -translate-y-1/2 rounded-full bg-white bg-gradient-to-t to-40% md:h-3/4 md:w-fit" />
