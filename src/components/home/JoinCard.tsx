...
const JoinUsCard = ({ title, description, icon: Icon }: JoinUsCardProps) => {
  return (
    <div className="bg-naama-ivory-100 flex w-full flex-col items-center justify-center rounded-4xl p-6 text-wrap shadow-md shadow-black sm:p-8">
      ...
      <div className="bg-naama-blue-100/60 text-naama-blue-300 mt-auto self-center rounded-full p-2 md:self-end">
