  ...
  return (
    <div className="bg-naama-blue-100 font-nunito flex w-screen justify-center gap-5 pt-10 pr-15 pb-10 text-white">
      ...
      <div className="font-nunito flex w-2/3 flex-col pr-4">
        <div className="flex pb-3 font-bold">Workshops</div>
        ...
        <hr />
        <div className="flex pt-4 pb-3 font-bold">Guest Speakers</div>
        <div className="flex flex-row items-center justify-center pb-2">
          <div className="flex pb-2 text-xs">
          ...
          <div className="mb-5 ml-5 flex aspect-square w-10 flex-shrink-0 items-center justify-center rounded-full bg-white">
            <FaUserTie className="text-naama-blue-200 text-xl" />
          </div>
        </div>
        <hr />
        <div className="flex pt-4 pb-3 font-bold">Opportunities</div>
        <div className="flex flex-row items-center justify-center pb-2">
          <div className="flex pb-2 text-xs">
          ...
          <div className="mb-5 ml-5 flex aspect-square w-10 flex-shrink-0 items-center justify-center rounded-full bg-white">
            <FaHandHoldingHeart className="text-naama-blue-200 text-xl" />
          </div>
        </div>
        <hr />
      </div>
